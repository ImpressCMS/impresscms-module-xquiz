...
try 
{
	...
	switch ($action)
	{
		case 'v':
			...
			$nav  = new icms_view_PageNav($nume ,$limit ,$start ,'start' ,"act=s&q=$id");
		...
		default:
			...
			$nav  = new icms_view_PageNav($count ,$limit ,$start ,'start',"?cid=$cid" );
			echo "<div align='center'>".$nav->renderImageNav().'</div><br />';
...
{
	redirect_header(ICMS_URL.'/modules/xquiz/index.php', 3, $e->getMessage());
}
