...
include_once ICMS_ROOT_PATH . '/modules/xquiz/class/class.sfiles.php';
...
try {
		...
		case 'addCategory' :
			...
			if (isset ( $_POST ['xoops_upload_file'] )) {
				...
				if (xoops_trim ( $fldname != '' )) {
					$sfiles = new sFiles ( );
					$dstpath = ICMS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/images/topics';
	...
	redirect_header ( ICMS_URL . '/modules/xquiz/admin/index.php' . $arr [1], 3, $arr [0] );
}
?>