		...
		case 'Stat' :
			...
			if (isset ( $id )) {
				...
				if (isset ( $_GET ['exp'] ) && $_GET ['exp'] == 'on') {
					...
					$fp = fopen ( '../../../uploads/quiz.csv', 'w+b' ) or redirect_header ( ICMS_URL . '/modules/xquiz/admin/index.php?op=Stat', 3, '_QUIZ_OPEN_CSV_ERR' );
...
';
					...
					#end region
					fwrite ( $fp, $msg ) or redirect_header ( ICMS_URL . '/modules/xquiz/admin/index.php?op=Stat', 3, '_QUIZ_OPEN_CSV_ERR' );
					;
					fclose ( $fp );
					echo "
						...
						<tr class='even'>
							...
							<td width='3%'>
								<img src='" . ICMS_URL . "/modules/xquiz/images/xls.gif' />
							</td>
							<td>
								<a href='" . ICMS_URL . "/uploads/quiz.csv'>
									" . _QUIZ_CSV_DOWNLOAD . "
								</a>
							</td>
							<td width='40%'>
				...
				$temp = "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='topnewsubicon' name='topnewsubicon' src='" . ICMS_URL . "/modules/xquiz/images/close12.gif' alt='' />
				...
				$class = 'even';
				$detImage = "<img src= \"" . ICMS_URL . "/modules/xquiz/images/detail.gif \" >";
				...
				foreach ( $listQuiz as $key ) {
					...
					$temp = $temp . "
						<tr class='" . $class . "'>
							<td>
								<a href=\"" . ICMS_URL . "/userinfo.php?uid=" . $key ['userid'] . "\">" . $key ['uname'] . "</a>
							</td>
							<td>
								" . $key ['name'] . "
							</td>
							...
							<td>
							<a href=\"" . ICMS_URL . "/modules/xquiz/admin/index.php?op=Stat&Id=" . $key ['id'] . "&uid=" . $key ['userid'] . "\">" . $detImage . "</a>
							</td>
						</tr>";
				}
				$temp = $temp . "</table></div>";
		...
		case 'Qst' :
			...
			switch ($action) {
				case 'add' :
					...
					question::showQuizSelectForm();
					if (isset ( $id ))
						question::QuestAddForm ( $id, $answerType );
					break;
		...
		default :
			...
			echo $tpl->fetch ( ICMS_ROOT_PATH . '/modules/xquiz/admin/tpls/qz_index.html' );
			break;
	}
} catch ( Exception $e ) {
