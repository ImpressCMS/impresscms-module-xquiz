...
include_once ICMS_ROOT_PATH.'/modules/xquiz/class/question.php';
...
function quiz_collapsableBar($tablename = '', $iconname = '')
{
	...
	function showUserQuest($quizId ,$uid)
	{
		...
		$userImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/user.png \" alt='' >";
		$quizImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/quizz.png \" alt='' >";
		...
		$temp = "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='topnewsubicon' name='topnewsubicon' src='" .
				 ICMS_URL . "/modules/xquiz/images/close12.gif' alt='' />
					...
					<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'>
						<tr class='odd'>
							<td>
							<a href=\"".ICMS_URL."/modules/xquiz/admin/index.php?op=Stat&Id=".$quiz['id']."\">".$quizImage.$quiz['name']."</a>
							<a href='".ICMS_URL."/userinfo.php?uid=".$uid."'>".$userImage.$thisUser->getVar('uname')."</a>
							</td>
						</tr>
					</table>
		...
		$validImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/valid.png \" alt='' >";
		$invalidImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/invalid.png \" alt='' >";
    ...
    function sendEmail($user ,$score ,$qid)
    {
        ...
        $msg .=  _QUIZ_SCORE_PROFILE. ": ". ICMS_URL . "/modules/xquiz/index.php?act=p&q=".$qid."\n";
        $msg .= $xoopsConfig['sitename'] . ": ". ICMS_URL . "\n";
