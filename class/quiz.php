...
class Quiz
{
	...
	{	
		...
		$addQuiz_form = new XoopsThemeForm(_AM_QUIZ_NEW, "addquizfrom", 
						ICMS_URL.'/modules/xquiz/admin/backend.php','post',true);
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='topnewquiz' name='topnewquiz' src='" .
				 	ICMS_URL . "/modules/xquiz/images/close12.gif' alt='' />
	...
	public static function showQuizs($start ,$limit ,$categoryId = -1)
	{
				 ...
				 ICMS_URL . "/modules/xquiz/images/close12.gif' alt='' />
					...
					<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'>
						<tr class='odd'>
							...
							<img src= \"".ICMS_URL."/modules/xquiz/images/new.png \" >
		...
		$class = 'even';
		$onImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/on.png \" >";
		$offImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/off.png \" >";
		$delImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/delete.gif \" title="._QUIZ_DEL." alt='' >";
		$editImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/edit.gif \" title="._QUIZ_EDIT." alt='' >";
		$statImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/stat.gif \" title="._QUIZ_STAT." alt='' >";
		$addImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/add.png \" title="._QUIZ_QUEST_ADD." alt='' >";
		$exportImage = "<img src= \"".ICMS_URL."/modules/xquiz/images/export.png \" title="._QUIZ_CSV_EXPORT." alt='' >";
		...
		foreach ($listQuiz as $key)
		{
			...
			$questLink = ((!$key['status'])&&($key['active']))?
					"<a href=\"".ICMS_URL."/modules/xquiz/admin/index.php?op=Quest&act=add&Id="
						.$key['id']."\">".$addImage." ".$key['question']."
					</a>":$key['question'];
			$category = Category::retriveCategory($key['cid']);
			$quizCategory = "<a href=\"".ICMS_URL."/modules/xquiz/index.php?cid="
			...
			<tr class='".$class."'>
				<td>
					<a href=\"".ICMS_URL."/modules/xquiz/index.php?act=v&q=".$key['id']."\">".$key['name']."</a>
				</td>
				<td>
					".$quizCategory."
				</td>
				...
				<td>
				<a href=\"".ICMS_URL."/modules/xquiz/admin/index.php?op=Quiz&act=del&Id=".$key['id']."\">
				".
				$delImage
				."
				</a>
				<a href=\"".ICMS_URL."/modules/xquiz/admin/index.php?op=Quiz&act=edit&Id=".$key['id']."\">
				".
				$editImage
				."
				</a>
				<a href=\"".ICMS_URL."/modules/xquiz/admin/index.php?op=Stat&Id=".$key['id']."\">
				".
				$statImage
				."
				</a>
				<a href=\"".ICMS_URL."/modules/xquiz/admin/index.php?op=Stat&Id=".$key['id']."&exp=on\">
				".
				$exportImage
				."
				</a>
		...
		$temp = $temp."</table></div>";
		echo $temp;	
		$nav  = new icms_view_PageNav($nume ,$limit ,$start ,'start',"op=Quiz" );
