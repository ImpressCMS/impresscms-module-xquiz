	...
	public static function showQuestions($start,$limit,$qid)
	{
		...
		foreach ($listQuestion as $key)
		{
			...
			<tr class='".$class."'>
				...
				<td>
				<a href=\"".ICMS_URL."/modules/xquiz/admin/index.php?op=Quest&act=del&Id=".$key['id']."\">
				".
				$delImage
				."
				</a>
				<a href=\"".ICMS_URL."/modules/xquiz/admin/index.php?op=Quest&act=edit&Id=".$key['id']."&qId=".$key['qid']."\">
				".
				$editImage
				."
				</a>
		...
		$temp = $temp."</table></div>";
		echo $temp;	
		$nav  = new icms_view_PageNav($nume ,$limit ,$start ,'start',"op=Quest&Id=$qid" );
